...
import type { SkillId, SkillSpec, StageWaveTable, TowerKind, UnitKind } from './types';
 ...
 * - splash Lv1: 6 / 1.4s = 4.3 DPS이지만 사거리 내 **전원**에게 적용된다. 적이 6체 겹치면
 *   실효 26 DPS로 basic 한 기 반 몫이라, 후반 대군 웨이브에서만 값을 한다 — 이 비선형성이
 *   광역 포탑의 유일한 정체성이므로 배수를 유지했다.
 */
